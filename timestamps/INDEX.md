...
| `README.md.ots` | current `HEAD` (2026-09-20) | Entry tables and the price-fields rule moved out to `log.md`; README points at it; verification section documents both chains. |
